...
export const SectionSkills = () => {
    return (
        <div className='col-span-12 flex md:h-screen text-left flex-col p-3 md:flex-row min-h-[600px]'>
          ...
          <h3 className="text-gray-400 flex mt-5"><span><img src={line} alt="line" className="mx-3" /></span>Mis habilidades</h3>
           <h2 className='text-white text-2xl md:text-6xl md:my-6 my-4'>Mis lenguajes</h2>
