...
export const Social = () => {
    return (
        <div className='md:flex text-white flex-row w-full space-x-4 text-2xl pt-3  my-6 z-50 hidden'>
            ...
            <a href="https://github.com/AxelTinoco" target="_blank" rel="noopener noreferrer">
                <ImGithub className=' opacity-50 hover:opacity-100 cursor-pointer'/>
            </a>
            <a href="https://www.linkedin.com/in/axeltinoco/" target="_blank" rel="noopener noreferrer">
